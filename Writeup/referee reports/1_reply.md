...
We do not wish to downplay or minimise the referee's concerns, which we feel remain justifiable from a perspective of principled skepticism. We respond to their points as far as they remain valid, and supplement our existing analysis with additional statistical tests, so as to more quantitatively assess and compare the strengths of the various claims that we have made. In addition, we have tried our best to address the referee's other concerns, pertaining to the overall structure and organisation of the work. It is our hope that the referee agrees that this has improved the clarity and readability of the revised work.
