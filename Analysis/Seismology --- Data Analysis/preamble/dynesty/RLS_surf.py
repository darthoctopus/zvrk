...
δν_min = 2*0.02 - SURF_RATE
δν_max = 2*0.18 - SURF_RATE
...
N_shared = 8 # 8 shared parameters: inclination, Γ, granulation (x2), background, and RLS parameters
shared_quantities = ['i', 'Γ', 'BG1', 'BG2', 'BG3', 'ν_in', 't_shear', 'Δt_shear']
...
checkpoint = "checkpoints/RLS_surf.npy"
...
def prior_transform(x):
    ...
    return jnp.array([i, Γ, BG1, BG2, BG3, ν_in, t_shear, Δt_shear, *ν0, *A])
