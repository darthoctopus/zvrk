...
We agree that our identified quadrupole modes are lower in amplitude than the others in our identification (as a result of both mode visibility, and the distribution of power across more multiplet components). We now report results from a H1 likelihood-ratio test in the appendix, as statistical justification for their not being spurious.
