We thank the referee for a detailed and constructive report, to which points we respond in the order that they appear. Where necessary, excerpts appearing verbatim in our corrected manuscript are marked out in **bold face**.

Before we respond to their specific comments, we first summarise the referee's overall notes, and our replies to them.

Regarding data analysis, the bulk of the referee's misgivings appear to be a result of a single misunderstanding, owing to a plotting error on our part in the construction of Fig. 1 specifically. Had it been correct as shown, the referee judges, correctly, that our seismic detection would have been spurious. Many of the referee's comments follow from this specifically, as we note below.
...
This is consistent with earlier practice fitting dipole modes from red giants (e.g. DIAMONDS, FAMED).
...
Yes it is! e.g. DIAMONDS reports a precision of 5 nHz for some cluster red giants.
...
Agreed that stastical uncertainties on these quantities are likely underestimated. However, not actually relevant to our discussion?
...
While this section is indeed weakly connected to the seismology per se (which we take that the referee assumes to be the focus of the paper given that it constitutes the majority of their feedback above), the astrophysical interpretation presented here is no less important than the various observational statements made preceding it. In accordance with the referee's wishes, we have shortened this section. However, we would appreciate more concrete feedback from the referee regarding specific parts of our discussion that they find weak.
...
Our intention with this section was to consider an alternative hypothesis where our claimed detection of solar-like oscillators was indeed spurious, and this star were rather some other kind of object. We hope that our general reorganisation makes this clearer.
...
That is a result of the paper, yes. Is there something that the referee wishes us to modify?